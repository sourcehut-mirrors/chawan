...
# Properties
  ...
  CSSShorthandType* = enum
    ...
    cstBorder = "border"
    cstMarginInlineStart = "margin-inline-start"
    cstMarginInlineEnd = "margin-inline-end"
    cstMarginBlockStart = "margin-block-start"
    cstMarginBlockEnd = "margin-block-end"
    cstMarginInline = "margin-inline"
    cstMarginBlock = "margin-block"
    cstPaddingInlineStart = "padding-inline-start"
    cstPaddingInlineEnd = "padding-inline-end"
    cstPaddingBlockStart = "padding-block-start"
    ...
    cstBorderBlockEndStyle = "border-block-end-style"
    cstBorderInlineStyle = "border-inline-style"
    cstBorderBlockStyle = "border-block-style"
    cstBorderInlineStartColor = "border-inline-start-color"
    cstBorderInlineEndColor = "border-inline-end-color"
    cstBorderBlockStartColor = "border-block-start-color"
    cstBorderBlockEndColor = "border-block-end-color"
    cstBorderInlineColor = "border-inline-color"
    cstBorderBlockColor = "border-block-color"
    cstBorderInlineStartWidth = "border-inline-start-width"
    cstBorderInlineEndWidth = "border-inline-end-width"
    cstBorderBlockStartWidth = "border-block-start-width"
    cstBorderBlockEndWidth = "border-block-end-width"
    cstBorderInlineWidth = "border-inline-width"
    cstBorderBlockWidth = "border-block-width"
    cstBorderInlineStart = "border-inline-start"
    cstBorderInlineEnd = "border-inline-end"
    cstBorderBlockStart = "border-block-start"
    cstBorderBlockEnd = "border-block-end"
    cstBorderInline = "border-inline"
...
proc `$`*(tok: CSSToken): string =
  ...
  of cttDimension:
    ...
    if tok.dt == cdtUnknown:
      ...
      s &= $tok.dt
    move(s)
  of cttPercentage: dtoa(tok.fnum) & '%'
  of cttWhitespace: " "
  of cttSemicolon: ";\n"
  of cttRbrace: "}\n"
  else: $tok.t
